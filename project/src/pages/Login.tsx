...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-teal-50">
      ...
      <div className="hidden lg:block lg:flex-1 relative">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-l from-blue-900/60 to-teal-900/60"></div>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-8 max-w-lg">
            <h1 className="text-4xl font-bold mb-4">Expert Medical Care</h1>
            ...
            <div className="flex items-center justify-center space-x-8 text-sm">
              <div className="text-center">
                ...
                <div className="opacity-75">Doctors</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">50K+</div>
                <div className="opacity-75">Patients</div>
              </div>
              <div className="text-center">
